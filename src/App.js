...
// --- 1. Composants Modaux et Formulaires Simples (Base) ---
...
// Composant de planification/envoi
...
// --- 2. Composants de Gestion des RDV ---
...
// --- 3. Composants de Vues Globales (utilisés par App) ---
...
// Composant du processus de rapport sanitaire (utilisé seulement comme fallback)
const SanitaryReportProcess = ({ onBackToHome }) => {
    return (
...
// Composant principal du Devis (QuoteProcess) - utilise tous les composants d'étape
...
         // FIX: Utilise items-stretch pour la hauteur et flex-col pour la disposition interne
...
            
            {/* FIX: Ajout de items-stretch pour que toutes les cartes aient la même hauteur (alignement) */}
